...
abstract class HtmlReporter<T extends FileReport, P> extends Reporter<T, P> {
  ...
  Future<void> copyResources() async {
    const resources = [
      'package:flutterando_metrics/src/reporters/resources/variables.css',
      'package:flutterando_metrics/src/reporters/resources/normalize.css',
      'package:flutterando_metrics/src/reporters/resources/base.css',
      'package:flutterando_metrics/src/reporters/resources/main.css',
    ];
